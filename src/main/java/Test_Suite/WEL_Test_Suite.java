...
public class WEL_Test_Suite extends DriverModule {
			...
			try {
				...
				try {
					...
					try {
						...
						Reporting.updateTestReport("Failed to click on CMAAddTOCart product due to timeout exception",
								CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
	...
	@Test
	public void TC40_PlaceOrderin_PINFlow_ForExistingUser() throws IOException {
		try {
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
			Reporting.test = Reporting.extent.createTest("TC40_PlaceOrderin_PINFlow_ForExistingUser");
			driver.get(excelOperation.getTestData("WEL_Env_URL", "Generic_Dataset", "Data"));
			driver.navigate().refresh();
			Thread.sleep(1000);
			try {
				wait.until(ExpectedConditions
						.elementToBeClickable(By.xpath("//div[@class='navbar-collapse']/ul/li[3]/a")));
				WEL.ClickOnActiacteCodeIcon();
				ScrollingWebPage.PageDown(driver, SS_path);
				WEL.EnterPinOnInputField(excelOperation.getTestData("TC40", "WEL_Test_Data", "PIN"));
	...
	@Test
	public void TC39_PlaceOrderin_PINFlow_ForNewUser() throws IOException {
		try {
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
			Reporting.test = Reporting.extent.createTest("TC39_PlaceOrderin_PINFlow_ForNewUser");
			driver.get(excelOperation.getTestData("WEL_Env_URL", "Generic_Dataset", "Data"));
			driver.navigate().refresh();
			Thread.sleep(1000);
			try {
				...
				try {
					...
					try {
						wait.until(ExpectedConditions
								.visibilityOfElementLocated(By.xpath("//input[@name='studentFirstName']")));
						WEL.EnterFirstName(excelOperation.getTestData("TC39", "WEL_Test_Data", "First_Name"));
						WEL.EnterLastName(excelOperation.getTestData("TC39", "WEL_Test_Data", "Last_Name"));
						String email = WEL.enterEmailIdInCreateAccountForm();
						WEL.confirmEmailIdInCreateAccountForm(email);
						WEL.EnterPassword(excelOperation.getTestData("TC39", "WEL_Test_Data", "Password"));
						WEL.ClickonAgreementCheckBox();
						WEL.ClickonTermsCheckBox();
						WEL.ClickingOnCreateAccoutButton();
			...
			try {
				...
				try {
					...
					try {
						...
						try {
							...
							try {
								...
								try {
									...
									Reporting.updateTestReport(
											"Failed to click on Add To cartProduct caused timeout exception",
											CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
								}
							} catch (Exception e) {
								Reporting.updateTestReport(
						...
						Reporting.updateTestReport("Failed to WEL Icon caused timeout exception",
								CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
				...
				Reporting.updateTestReport("Failed to click on Singout and caused timeout exception",
						CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			}
			driver.get(excelOperation.getTestData("WEL_Logout_URL", "Generic_Dataset", "Data"));
				...
				try {
					...
					try {
						...
						try {
							...
							try {
								wait.until(ExpectedConditions.elementToBeClickable(
										By.xpath("(//div[@class='simple-responsive-banner-component'])[1]/a")));
								WEL.ClickWELIconCheckoutPage();
								ScrollingWebPage.PageDown(driver, SS_path);
								try {
												...
												try {
													...
													try {
														...
														try {
															...
															try {
																...
																try {
																	...
																	try {
																		...
																		WEL.ClickingOnCreateAccoutButton();
																		WEL.GuestConfirmEmailId(Guestemail);
																		WEL.EnterPassword(excelOperation.getTestData(
																				"TC17", "WEL_Test_Data", "Password"));
																		WEL.ClickonAgreementCheckBox();
																		WEL.ClickingOnSaveAndContinue();
																		WEL.GuestFirstName(excelOperation.getTestData(
																				"TC17", "WEL_Test_Data",
																				"Guest_Fname"));
																		WEL.GuestLastName(excelOperation.getTestData(
																				"TC17", "WEL_Test_Data",
																				"Guest_Lname"));
																		WEL.selectShipCountry(
																				excelOperation.getTestData("TC17",
																						"WEL_Test_Data", "Sh_Country"));
																		WEL.ShipAddressLineOne(excelOperation
																				.getTestData("TC17", "WEL_Test_Data",
																						"Sh_Address_line1"));
																		WEL.ShipPostCode(excelOperation.getTestData(
																				"TC17", "WEL_Test_Data",
																				"Sh_Zip_Code"));

																		WEL.ShipTownCity(excelOperation.getTestData(
																				"TC17", "WEL_Test_Data",
																				"Sh_City/ Province"));
																		WEL.enterState(excelOperation.getTestData(
																				"TC17", "WEL_Test_Data", "Sh_State"));
																		...
																		ScrollingWebPage.PageScrolldown(driver, 0, 800,
																				SS_path);
																		excelOperation.updateTestData("TC17",
																				"WEL_Test_Data", "Order_Id", orderID);
																		String tax = WEL.fetchTaxAmount();
																		excelOperation.updateTestData("TC17",
																				"WEL_Test_Data", "Tax", tax);
																		String orderTotal = WEL.fetchOrderTotal();
																		excelOperation.updateTestData("T17",
																	...
																	Reporting.updateTestReport(
																			"Failed to click on CMAVieewCourse Product due to timeout exception",
																			CaptureScreenshot.getScreenshot(SS_path),
																			StatusDetails.FAIL);
																...
																Reporting.updateTestReport(
																		"Failed to click on CMAPrinteBook Product due to timeout exception",
																		CaptureScreenshot.getScreenshot(SS_path),
																		StatusDetails.FAIL);
															...
															Reporting.updateTestReport(
																	"Failed to click on CMA Add To Cart Product due to timeout exception",
																	CaptureScreenshot.getScreenshot(SS_path),
																	StatusDetails.FAIL);
														...
														Reporting.updateTestReport(
																"Failed to click on WEL ICon on Checkout due to timeout exception",
																CaptureScreenshot.getScreenshot(SS_path),
																StatusDetails.FAIL);
													}
												} catch (Exception e) {
													Reporting.updateTestReport(
															"Failed to click on Explore CPA Product due to timeout exception",
															CaptureScreenshot.getScreenshot(SS_path),
															StatusDetails.FAIL);
												}
											} catch (Exception e) {
												Reporting.updateTestReport(
														"Failed to click on CPAVieewCourse Product due to timeout exception",
														CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
											}
										} catch (Exception e) {
											Reporting.updateTestReport(
													"Failed to click on CPAPrinteBook Product due to timeout exception",
													CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
										}
									} catch (Exception e) {
										Reporting.updateTestReport(
												"Failed to click on CPA Add To Cart Product due to timeout exception",
												CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
								...
								Reporting.updateTestReport("Failed to click CFA Product due to timeout exception",
										CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
							}
						} catch (Exception e) {
							Reporting.updateTestReport("Failed to click CFA Explore Course due to timeout exception",
									CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
						}
					} catch (Exception e) {
						Reporting.updateTestReport("Failed to click CFA ViewCourse due to timeout exception",
								CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
					}
				} catch (Exception e) {
					Reporting.updateTestReport("Failed to click CFA Add To Cart Product due to timeout exception",
							CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
				}
			} catch (Exception e) {

				Reporting.updateTestReport("Failed to click on checkout Cart Page due to timeout exception",
						CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
																...
																try {
																	...
																	try {
																		...
																		WEL.EnterexistingUserName(excelOperation
																				.getTestData("TC73", "WEL_Test_Data",
																						"Email_Address"));
																		...
																		WEL.selectShipCountry(
																				excelOperation.getTestData("TC18",
																						"WEL_Test_Data", "Sh_Country"));
																		WEL.ShipAddressLineOne(excelOperation
																				.getTestData("TC18", "WEL_Test_Data",
																						"Sh_Address_line1"));
																		WEL.ShipPostCode(excelOperation.getTestData(
																				"TC18", "WEL_Test_Data",
																				"Sh_Zip_Code"));
																		...
																		ScrollingWebPage.PageScrolldown(driver, 0, 800,
																				SS_path);
																		excelOperation.updateTestData("TC18",
																				"WEL_Test_Data", "Order_Id", orderID);
																		String tax = WEL.fetchTaxAmount();
																		excelOperation.updateTestData("TC18",
																				"WEL_Test_Data", "Tax", tax);
	...
	public void TC69_PlaceNewUser_OrderForPhysicalProduct_CFALevelI_PlatinumAndValidateThetax() throws IOException {
		try {
			...
			try {
				...
				Reporting.updateTestReport("Failed to click ViewCourseLink due to timeout exception",
						CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			}
			WEL.logOutWEL(driver, excelOperation.getTestData("WEL_Logout_URL", "Generic_Dataset", "Data"));
		} catch (Exception e) {
	...
	public void TC70_PlaceExistingUser_OrderForPhysicalProduct_CFALevelI_PlatinumAndValidateThetax()
		...
		try {
			...
			try {
				...
				Reporting.updateTestReport("Failed to click on ViewCourseLinkProduct due to timeout exception",
						CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			}
			WEL.logOutWEL(driver, excelOperation.getTestData("WEL_Logout_URL", "Generic_Dataset", "Data"));
		} catch (Exception e) {
	...
	@Test
	public void TC80_Activatethe_PIN_Without_StartDate_AndEndDate_ForNewUser() throws IOException {
		try {
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
			Reporting.test = Reporting.extent
					.createTest("TC80_Activatethe_PIN_Without_StartDate_AndEndDate_ForNewUser");
			driver.get(excelOperation.getTestData("WEL_Env_URL", "Generic_Dataset", "Data"));
			driver.navigate().refresh();
			Thread.sleep(1000);
			try {
				...
				WEL.ClickOnActiacteCodeIcon();
				ScrollingWebPage.PageDown(driver, SS_path);
				WEL.EnterPinOnInputField(excelOperation.getTestData("TC80", "WEL_Test_Data", "PIN"));
				try {
					wait.until(ExpectedConditions.elementToBeClickable(By.xpath("")));
					WEL.ClickOnActivateButton();
					WEL.ClickOnCreateNewAccountForPIN();
					...
					try {
						wait.until(ExpectedConditions
								.visibilityOfElementLocated(By.xpath("//input[@name='studentFirstName']")));
						WEL.EnterFirstName(excelOperation.getTestData("TC80", "WEL_Test_Data", "First_Name"));
						WEL.EnterLastName(excelOperation.getTestData("TC80", "WEL_Test_Data", "Last_Name"));
						String email = WEL.enterEmailIdInCreateAccountForm();
						WEL.confirmEmailIdInCreateAccountForm(email);
						WEL.EnterPassword(excelOperation.getTestData("TC80", "WEL_Test_Data", "Password"));
						WEL.ClickonAgreementCheckBox();
						WEL.ClickonTermsCheckBox();
						WEL.ClickingOnCreateAccoutButton();
	...
	@Test
	public void TC81_Activatethe_PIN_Without_StartDate_AndEndDate_ForExistingUser() throws IOException {
		try {
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
			Reporting.test = Reporting.extent
					.createTest("TC81_Activatethe_PIN_Without_StartDate_AndEndDate_ForExistingUser");
			driver.get(excelOperation.getTestData("WEL_Env_URL", "Generic_Dataset", "Data"));
			driver.navigate().refresh();
			Thread.sleep(1000);
			try {
				...
				WEL.ClickOnActiacteCodeIcon();
				ScrollingWebPage.PageDown(driver, SS_path);
				WEL.EnterPinOnInputField(excelOperation.getTestData("TC81", "WEL_Test_Data", "PIN"));
				WEL.ClickOnActivateButton();
				WEL.EntePINUserName(excelOperation.getTestData("TC81", "WEL_Test_Data", "Email_Address"));
				WEL.EntePINPassword(excelOperation.getTestData("TC81", "WEL_Test_Data", "Password"));
				WEL.ClickOnPINLoginButton();
				try {
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='helpButton']")));
				} catch (Exception e) {
			...
			try {
				...
				try {
					...
					try {
						...
						try {
							...
							try {
								...
								try {
									...
									Reporting.updateTestReport(
											"Failed to click on Checkout OnCart Page due to  timeout exception",
											CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
								}
							} catch (Exception e) {
								Reporting.updateTestReport(
						...
						Reporting.updateTestReport("Failed to click on VieweCourseProduct due to  timeout exception",
								CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
					}
				} catch (Exception e) {
					Reporting.updateTestReport("Failed to click on ExploreCourseProduct due to  timeout exception",
							CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
	...
	public void TC19_PlaceOrderOf_CPACMACFA_SupplementCourse_ForNewUser() throws IOException {
		try {
			...
			WEL.ClickonCPAProduct();
			WEL.ClickOnProductdropdown();
			WEL.ClickOnViewSupplementsforCPA();
			try {
				wait.until(ExpectedConditions.visibilityOfElementLocated(
						By.xpath("(//div[@class='col-xs-12 col-sm-4 supplements-cards'])[2]/div/a")));
				WEL.ClickOnSupplementsProductforCPA();
				...
				try {
					...
					try {
						...
						try {
							...
							WEL.ClickOnViewSupplementsforCMA();
							WEL.ClickOnSupplementsProductforCMA();
							ScrollingWebPage.PageDown(driver, SS_path);
							WEL.ClickOnAddToCartForSupplement();
							WEL.clickOnWELHomePageLogoOnCartPage();
							ScrollingWebPage.PageDown(driver, SS_path);
							try {
								...
								WEL.ClickOnProductdropdown();
								WEL.ClickOnViewSupplementsforCFA();
								WEL.ClickOnSupplementsProductforCFA();
								WEL.ClickOnAddToCartForSupplement();
								WEL.ClickonCheckOutOnCartPage();
								String Gemail = WEL.EnterGuestUser();
								WEL.ClickingOnCreateAccoutButton();
								...
								WEL.selectBillCountry(
										excelOperation.getTestData("TC19", "WEL_Test_Data", "Bill_Country"));
								WEL.AddressLineOne(
										excelOperation.getTestData("TC19", "WEL_Test_Data", "Bill_Address_line1"));
								...
								WEL.EnterCity(
										excelOperation.getTestData("TC19", "WEL_Test_Data", "Bill_City/ Province"));
								WEL.EnterPhoneNumber(
										excelOperation.getTestData("TC19", "WEL_Test_Data", "Bill_Phone_Number"));
								try {
									driver.switchTo()
											.frame(driver.findElement(By.xpath(".//iframe[@title='cardholder name']")));
									wait.until(ExpectedConditions.elementToBeClickable(By.id("nameOnCard")));
									WEL.enterCardHolderName(
											excelOperation.getTestData("TC19", "WEL_Test_Data", "Guest_Fname"));
									driver.switchTo().defaultContent();
									driver.switchTo()
											.frame(driver.findElement(By.xpath(".//iframe[@title='card number']")));
									WEL.enterCardNumber(
											excelOperation.getTestData("TC19", "WEL_Test_Data", "Card_Number"));
									driver.switchTo().defaultContent();
									driver.switchTo()
											.frame(driver.findElement(By.xpath(".//iframe[@title='expiryMonth']")));
									WEL.selectExpirationMonthFromDropDown(
									...
									Reporting.updateTestReport(
											"Failed to Enter the Carrd detais due to  timeout exception",
											CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
								}
								WEL.SaveAndContinueCheckOut();
								/*
								 * try { if
								 * (WEL.returnUseSelectedBillingAddressButtonAddressDoctorPopUp().isDisplayed())
								 * WEL.clickOnUseSelectedBillingAddressButtonAddressDoctor(); } catch (Exception
								 * e) { Reporting.
								 * updateTestReport("Address Suggestiond page is not appering on Billing page",
								 * CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL); }
								 */
								WEL.clickOnPlaceOrderButton();
								String orderID = WEL.fetchOrderId();
							...
							Reporting.updateTestReport("Failed to click onProduct drop down due to  timeout exception",
									CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
						}
					} catch (Exception e) {
						Reporting.updateTestReport("Failed to click on CMA Product due to  timeout exception",
					...
					Reporting.updateTestReport(
							"Failed to click on Add To cart For Supplement due to  timeout exception",
							CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
				}
			} catch (Exception e) {
				Reporting.updateTestReport("Failed to click onSupplement Product for CPA due to  timeout exception",
						CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			}
		} catch (Exception e) {
			Reporting.updateTestReport("Exception occured: " + e.getClass().toString(),
	...
	@Test
	public void TC41_PlaceOrderin_PINFlowfor_ExistingUser_AlreadyLoggedin() throws IOException {
		try {
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
			Reporting.test = Reporting.extent.createTest("TC41_PlaceOrderin_PINFlowfor_ExistingUser_AlreadyLoggedin");
			driver.get(excelOperation.getTestData("WEL_Env_URL", "Generic_Dataset", "Data"));
			driver.navigate().refresh();
			WEL.ClickingOnLoginButton();
			WEL.EnterUserNameOnLoginPage(excelOperation.getTestData("TC41", "WEL_Test_Data", "Email_Address"));
			WEL.EnterPasswordOnLoginPage(excelOperation.getTestData("TC41", "WEL_Test_Data", "Password"));
			WEL.ClickonLoginButton();
			try {
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'I Accept')]")));
				Reporting.updateTestReport("Wiley & WEL Privacy Agreement banner was displayed",
			...
			WEL.ClickOnActiactePIN();
			WEL.EnterPinOnInputField(excelOperation.getTestData("TC41", "WEL_Test_Data", "PIN"));
			WEL.ClickOnActivateButton();
			WEL.EntePINUserName(excelOperation.getTestData("TC41", "WEL_Test_Data", "Email_Address"));
			WEL.EntePINPassword(excelOperation.getTestData("TC41", "WEL_Test_Data", "Password"));
			WEL.ClickOnPINLoginButton();
			WEL.logOutWEL(driver, excelOperation.getTestData("WEL_Logout_URL", "Generic_Dataset", "Data"));
		} catch (Exception e) {
			Reporting.updateTestReport("Exception occured: " + e.getClass().toString(),
								...
								try {
									...
									try {
										...
										try {
											...
											WEL.ClickOnCPAAddProduct();
											WEL.ClickonCheckOutOnCartPage();
											WEL.EnterexistingUserName(excelOperation.getTestData("TC26",
													"WEL_Test_Data", "Email_Address"));
											WEL.EnterPasswordLoginPage(
													excelOperation.getTestData("TC26", "WEL_Test_Data", "Password"));
											WEL.ClickonLoginAndContinue();
											WEL.ClickonCheckOutOnCartPage();
											WEL.ClickonCheckOutOnCartPage();
											...
											Reporting.updateTestReport(
													"Failed to click on CMA Product and caused timeout exception",
													CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
										}
									} catch (Exception e) {
										Reporting.updateTestReport(
												"Failed to click on ExploreCourseCMAProduct and caused timeout exception",
												CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
									}
								} catch (Exception e) {
									Reporting.updateTestReport(
											"Failed to click on viewCourse for CMA Product and caused timeout exception",
											CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
								}
							} catch (Exception e) {
								Reporting.updateTestReport("Failed to click on CMAeBook and caused timeout exception",
										CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
							}
						} catch (Exception e) {
							Reporting.updateTestReport(
									"Failed to click on CMA Add To cart and caused timeout exception",
									CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
						}
					} catch (Exception e) {
						Reporting.updateTestReport("Failed to click on CPA Product and caused timeout exception",
								CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
					}
				} catch (Exception e) {
					Reporting.updateTestReport("Failed to click on CMAExploreCourse and caused timeout exception",
							CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
				}
			} catch (Exception e) {
				Reporting.updateTestReport("Failed to click on CMAViewCourse and caused timeout exception",
						CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			}
		} catch (Exception e) {
			Reporting.updateTestReport("Exception occured: " + e.getClass().toString(),
