...
public class CoD_Regression_Test_Suite extends DriverModule {
	...
	private static String cod_DEV_CreateAccount_URL = excelOperation.getTestData("Dev_CreateAccount_URL", "CoD_Test_Data", "Test_Data");
	...
	private static String mastercard2series=excelOperation.getTestData("Mastercard_2series", "Valid_Cards", "Test_Data");
	private static String insufficientFundDecline=excelOperation.getTestData("insufficientFundDecline", "CoD_Test_Data", "Test_Data");
	private static String lostCardDecline=excelOperation.getTestData("lostCardDecline", "CoD_Test_Data", "Test_Data");
	private static String stolenCardDecline=excelOperation.getTestData("stolenCardDecline", "CoD_Test_Data", "Test_Data");
	private static String incorrectCVCDecline=excelOperation.getTestData("incorrectCVCDecline", "CoD_Test_Data", "Test_Data");
	private static String expiredCardDecline=excelOperation.getTestData("expiredCardDecline", "CoD_Test_Data", "Test_Data");
	private static String processingErrorDecline=excelOperation.getTestData("processingErrorDecline", "CoD_Test_Data", "Test_Data");
	private static String inValidFirstName=excelOperation.getTestData("inValidFirstName", "CoD_Test_Data", "Test_Data");
	...
	private static String differentConfirmEmail=excelOperation.getTestData("differentConfirmEmail", "CoD_Test_Data", "Test_Data");
	...
	private static String inValidConfirmPassword=excelOperation.getTestData("inValidConfirmPassword", "CoD_Test_Data", "Test_Data");
	private static String updateCardNumber = excelOperation.getTestData("updateCardNumber", "CoD_Test_Data", "Test_Data");
	private static String updateExpiryDate = excelOperation.getTestData("updateExpiryDate", "CoD_Test_Data", "Test_Data");
    ...
    private static String inValidExpiryDate=excelOperation.getTestData("inValidExpiryDate", "CoD_Test_Data", "Test_Data");
    private static String inCompleteCardNumber=excelOperation.getTestData("inCompleteCardNumber", "CoD_Test_Data", "Test_Data");
    private static String inValidCardNumber=excelOperation.getTestData("inValidCardNumber", "CoD_Test_Data", "Test_Data");
    private static String inCompleteExpiryDate=excelOperation.getTestData("inCompleteExpiryDate", "CoD_Test_Data", "Test_Data");
    private static String vat=excelOperation.getTestData("vat", "CoD_Test_Data", "Test_Data");
    private static String recurringMonthlyBill=excelOperation.getTestData("recurringMonthlyBill", "CoD_Test_Data", "Test_Data");
	...
	public void TC03_verifyLoginFromLoginPage() throws IOException, InterruptedException {		
		...
		//Assert.assertEquals(loginPageObject.verifyLoginPage(), true,"Login Page is not visible"); 
		loginPageObject.clickOnNavigationMenu();
	...
	public void TC04_verifyRegistrationFieldValidationOnCheckout() throws IOException, InterruptedException {
		...
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(20));		
		createAccountPageObject.clickOnCreateANewAccountLink();
		Assert.assertEquals(createAccountPageObject.getPageTextCreateAccount(), 
				"Create Account");
		...
		Assert.assertEquals(createAccountPageObject.clickOnOffersCheckBox(), true, 
				"Offers Checkbox is not visible");
	...
	public void TC07_billingInformationFieldsValidation() throws InterruptedException, IOException {
		...
		//Assert.assertEquals(subscriptionAccountPageObject.verifyCreditCardErrorMessage(),"First Name must contain only letters, apostrophes or dashes.");		
    ...
    public void TC17_changePaymentMethod() throws IOException, InterruptedException {
        ...
        subscriptionAccountPageObject.enterWPSSecurePaymentDetails(updateCardNumber, updateExpiryDate, updateCVV, driver);
        subscriptionAccountPageObject.clickOnSubmitOrderButton(driver);
	...
	public void TC46_verifyInsufficientFundDecline () throws InterruptedException, IOException {
		...
		subscriptionAccountPageObject.enterWPSSecurePaymentDetails(insufficientFundDecline, expiryDate, cvc, driver);
		subscriptionAccountPageObject.clickOnSubmitOrderButton(driver);
		Assert.assertEquals(subscriptionAccountPageObject.verifyErrorMessageForCards(),
