...
//	WebElement CustomerEmailField;
	...
	/*
	 * @Author: Anindita
	 * @Description: Enters the username in Backoffice login page
	 */
	...
	/*
	 * @Author: Anindita
	 * @Description: Enters the password in Backoffice login page
	 */
	...
	/*
	 * @Author: Anindita
	 * @Description: Clicks on the Login button in Backoffice login page
	 */
	...
	/*
	 * @Author: Anindita
	 * @Description: Checks if user is logged in in Hybris Backoffice or not
	 */
	...
	/*
	 * @Author: Anindita
	 * @Description: Searches a field in the left pane in Hybris Backoffice
	 */
	...
	/*
	 * @Author: Anindita
	 * @Description: Clicks on the Subscription field in left pane in Hybris Backoffice
	 */
	 ...
	 */
		 ...
		 * @Author: Anindita
		 * @Added on 08/08/22
		 * @Description: Clicks on the Orders element in left pane
		 */
		public void clickOnOrders() throws IOException {
			try {
				Orders.click();
				Reporting.updateTestReport("Orders was clicked ",CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
			}
			catch(Exception e){
				Reporting.updateTestReport("Orders couldn't be clicked with error message "+e.getClass().toString(),CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			}
		}
		/*
		 * @Author: Anindita
