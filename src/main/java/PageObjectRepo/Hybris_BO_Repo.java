...
public class Hybris_BO_Repo {
	...
	@FindBy(xpath="(//*[@class='ye-validation-panel z-div']/../input[@class='ye-input-text ye-com_hybris_cockpitng_editor_defaulttext z-textbox'])[1]")
	WebElement ArticleNumber;
	@FindBy(xpath="(//*[@class='yw-loceditor-caption z-div']/../*[@class='yw-loceditor-row ye-validation-none z-div'])[1]")
	WebElement Identifier;
	@FindBy(xpath="//*[contains(text(),'Multimedia')]/../span[@class='yw-editorarea-tablabel z-label']")
	WebElement MultimediaTab;
//	@FindBy(xpath="(//*[@class='z-listcell-content']/div/span[@class='ye-default-reference-editor-selected-item-label z-label'])[8]")
	@FindBy(xpath="(//*[@class='z-listcell-content']/div[@class='ye-default-reference-editor-selected-item-container ye-remove-enabled z-div'])[8]")
	WebElement ExternalImage;
	@FindBy(xpath="(//*[@class='z-image']/../span[@class='ye-default-reference-editor-selected-item-label z-label'])[2]")
	WebElement MediaURL;
	...
	public void clickEssentialArrowButtonForExpand() throws IOException{
		try {
			EssentialArrowButtonForExpand.click();
			Reporting.updateTestReport("The Essential arrow up button was clicked successfully to expand the lower order details part",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
		}
		catch(Exception e) {
			Reporting.updateTestReport("The Essential arrow up button couldn't be clicked to expand the lower order details part",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
		}
	}
	
	public String getArticleNumber() throws IOException{
		try {
			String articleNumber = ArticleNumber.getAttribute("value");
			Reporting.updateTestReport("Article number from Hybris BO is fetched",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
			return articleNumber;

		} catch (Exception e) {
			Reporting.updateTestReport("Article number from Hybris BO failed to fetch " + e.getClass().toString(),
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			return "";
		}
	}	
	...
	public String getIdentifier() throws IOException{
		try {
			String identifier = Identifier.getAttribute("value");
			Reporting.updateTestReport("Identifier value from Hybris BO is fetched",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
			return identifier;

		} catch (Exception e) {
			Reporting.updateTestReport("Identifier value from Hybris BO failed to fetch " + e.getClass().toString(),
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			return "";
		}
	}

	public String getItemNumber() throws IOException{
		try {
			String ItemNumber=excelOperation.getTestData("TC02", "Item_Feed_Validation", "id");
			Reporting.updateTestReport("Item Number from excel fetched",CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
			return ItemNumber;
		}
		catch(Exception e) {
			Reporting.updateTestReport("Item Number from excel not fetched "+e.getClass().toString(),CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			return "";
		}
	}
	...
	public String getItemName() throws IOException{
		try {
			String ItemName=excelOperation.getTestData("TC02", "Item_Feed_Validation", "item_name");
			Reporting.updateTestReport("Item Name from excel fetched",CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
			return ItemName;
		}
		catch(Exception e) {
			Reporting.updateTestReport("Item Name from excel not fetched "+e.getClass().toString(),CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
			return "";
		}
	}
	
	public void clickOnMultimediaTab() throws IOException{
		try {
			MultimediaTab.click();
			Reporting.updateTestReport("The Multimedia Tab was clicked successfully",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
		}
		catch(Exception e) {
			Reporting.updateTestReport("The Multimedia Tab couldn't be clicked ",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
		}
	}
	
	public void doubleClickOnExternalImage() throws IOException{
		try {
			Actions act = new Actions(driver);
			act.doubleClick(ExternalImage);
			act.doubleClick();
			Reporting.updateTestReport("The External Image was clicked successfully",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
		}
		catch(Exception e) {
			Reporting.updateTestReport("The External Image couldn't be clicked ",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.FAIL);
		}
	}
	...
	public String getMediaURL() throws IOException{
		try {
			String mediaURL = MediaURL.getDomAttribute("value");
			Reporting.updateTestReport("The External Image was clicked successfully",
					CaptureScreenshot.getScreenshot(SS_path), StatusDetails.PASS);
			return mediaURL;
		}
